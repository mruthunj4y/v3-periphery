...
import type { InterfaceMulticall } from "../InterfaceMulticall";

export class InterfaceMulticall__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<InterfaceMulticall> {
    return super.deploy(overrides || {}) as Promise<InterfaceMulticall>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): InterfaceMulticall {
    return super.attach(address) as InterfaceMulticall;
  }
  connect(signer: Signer): InterfaceMulticall__factory {
    return super.connect(signer) as InterfaceMulticall__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): InterfaceMulticall {
    return new Contract(address, _abi, signerOrProvider) as InterfaceMulticall;
  }
}
  ...
  },
  {
    inputs: [
      {
        ...
        internalType: "struct InterfaceMulticall.Call[]",
        name: "calls",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct InterfaceMulticall.Result[]",
        name: "returnData",
        type: "tuple[]",
      },
    ],
