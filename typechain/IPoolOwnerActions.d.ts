...
interface IPoolOwnerActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IPoolOwnerActions extends Contract {
  ...
  interface: IPoolOwnerActionsInterface;
