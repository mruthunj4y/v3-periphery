...
interface InterfaceMulticallInterface extends ethers.utils.Interface {
  functions: {
...
export class InterfaceMulticall extends Contract {
  ...
  interface: InterfaceMulticallInterface;
