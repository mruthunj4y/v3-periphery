...
interface IFactoryInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "ProxyImplementationChanged(address,address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "ProxyImplementationChanged"): EventFragment;
}
...
export class IFactory extends Contract {
  ...
  filters: {
    AdminChanged(oldAdmin: string | null, newAdmin: string | null): EventFilter;
